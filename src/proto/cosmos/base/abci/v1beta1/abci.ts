...
export const TxResponse = {
  ...
  fromJSON(object: any): TxResponse {
    ...
    message.rawLog =
      object.rawLog !== undefined && object.rawLog !== null ? String(object.rawLog) : ''
  ...
  fromPartial<I extends Exact<DeepPartial<TxResponse>, I>>(object: I): TxResponse {
    ...
    message.gasUsed =
      object.gasUsed !== undefined && object.gasUsed !== null
        ...
        : Long.ZERO
    message.tx =
      object.tx !== undefined && object.tx !== null ? Any.fromPartial(object.tx) : undefined
...
export const MsgData = {
  ...
  fromJSON(object: any): MsgData {
    const message = { ...baseMsgData } as MsgData
    message.msgType =
      object.msgType !== undefined && object.msgType !== null ? String(object.msgType) : ''
    message.data =
      object.data !== undefined && object.data !== null
        ? bytesFromBase64(object.data)
        : new Uint8Array()
