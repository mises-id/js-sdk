  ...
  fromJSON(object: any): Part {
    ...
    message.bytes =
      object.bytes !== undefined && object.bytes !== null
        ...
        : new Uint8Array()
    message.proof =
      object.proof !== undefined && object.proof !== null ? Proof.fromJSON(object.proof) : undefined
    return message
  },
...
export const Vote = {
  ...
  fromJSON(object: any): Vote {
    const message = { ...baseVote } as Vote
    message.type =
      object.type !== undefined && object.type !== null ? signedMsgTypeFromJSON(object.type) : 0
    message.height =
      object.height !== undefined && object.height !== null
        ? Long.fromString(object.height)
        : Long.ZERO
  ...
  fromJSON(object: any): Commit {
    ...
    message.blockId =
      object.blockId !== undefined && object.blockId !== null
        ? BlockID.fromJSON(object.blockId)
        : undefined
    message.signatures = (object.signatures ?? []).map((e: any) => CommitSig.fromJSON(e))
    return message
  },
