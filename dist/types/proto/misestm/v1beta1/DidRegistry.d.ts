...
export declare const DidRegistry: {
    encode(message: DidRegistry, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): DidRegistry;
    ...
    } & Record<Exclude<keyof I, keyof DidRegistry>, never>>(object: I): DidRegistry;
};
