    ...
    fromJSON(object) {
        ...
        message.proof =
            object.proof !== undefined && object.proof !== null
                ? proof_1.Proof.fromJSON(object.proof)
                : undefined;
        return message;
    },
    toJSON(message) {
    ...
    fromPartial(object) {
        ...
        message.blockId =
            object.blockId !== undefined && object.blockId !== null
                ...
                : undefined;
        message.signatures =
            ((_b = object.signatures) === null || _b === void 0 ? void 0 : _b.map((e) => exports.CommitSig.fromPartial(e))) || [];
        return message;
    },
};
    ...
    fromJSON(object) {
        ...
        message.commit =
            object.commit !== undefined && object.commit !== null
                ? exports.Commit.fromJSON(object.commit)
                : undefined;
        return message;
    },
    toJSON(message) {
    ...
    fromJSON(object) {
        ...
        message.numTxs =
            object.numTxs !== undefined && object.numTxs !== null
                ? long_1.default.fromString(object.numTxs)
                : long_1.default.ZERO;
        return message;
    },
    toJSON(message) {
