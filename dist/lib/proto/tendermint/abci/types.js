    ...
    fromJSON(object) {
        ...
        message.echo =
            object.echo !== undefined && object.echo !== null
                ? exports.RequestEcho.fromJSON(object.echo)
                : undefined;
        message.flush =
        ...
        message.info =
            object.info !== undefined && object.info !== null
                ? exports.RequestInfo.fromJSON(object.info)
                : undefined;
        message.setOption =
...
exports.RequestInfo = {
    ...
    toJSON(message) {
        ...
        message.p2pVersion !== undefined &&
            (obj.p2pVersion = (message.p2pVersion || long_1.default.UZERO).toString());
        return obj;
    },
    fromPartial(object) {
        var _a;
    ...
    fromJSON(object) {
        ...
        message.header =
            object.header !== undefined && object.header !== null
                ? types_1.Header.fromJSON(object.header)
                : undefined;
    ...
    fromPartial(object) {
        ...
        message.lastCommitInfo =
            object.lastCommitInfo !== undefined && object.lastCommitInfo !== null
                ...
                : undefined;
        message.byzantineValidators =
            ((_b = object.byzantineValidators) === null || _b === void 0 ? void 0 : _b.map((e) => exports.Evidence.fromPartial(e))) || [];
        return message;
    },
};
...
exports.Response = {
    ...
    fromJSON(object) {
        ...
        message.echo =
            object.echo !== undefined && object.echo !== null
                ? exports.ResponseEcho.fromJSON(object.echo)
                : undefined;
        message.flush =
            object.flush !== undefined && object.flush !== null
        ...
        message.info =
            object.info !== undefined && object.info !== null
                ? exports.ResponseInfo.fromJSON(object.info)
                : undefined;
        message.setOption =
            object.setOption !== undefined && object.setOption !== null
...
exports.ResponseCheckTx = {
    ...
    toJSON(message) {
        ...
        message.gasWanted !== undefined &&
            (obj.gas_wanted = (message.gasWanted || long_1.default.ZERO).toString());
        message.gasUsed !== undefined &&
            (obj.gas_used = (message.gasUsed || long_1.default.ZERO).toString());
        if (message.events) {
            obj.events = message.events.map((e) => (e ? exports.Event.toJSON(e) : undefined));
        }
        else {
...
exports.ResponseCommit = {
    ...
    toJSON(message) {
        ...
        message.retainHeight !== undefined &&
            (obj.retainHeight = (message.retainHeight || long_1.default.ZERO).toString());
        return obj;
    },
    fromPartial(object) {
        var _a;
    ...
    fromJSON(object) {
        ...
        message.power =
            object.power !== undefined && object.power !== null
                ? long_1.default.fromString(object.power)
                : long_1.default.ZERO;
        return message;
    },
    toJSON(message) {
